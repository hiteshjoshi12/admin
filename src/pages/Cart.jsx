  ...
  const [cartItems, setCartItems] = useState([
    {
      ...
      price: 2499,
      quantity: 1,
      image: "https://images.unsplash.com/photo-1605218427368-35b866c24195?q=80&w=600"
    },
    {
      id: 2,
      name: "Velvet Mules",
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="w-full lg:w-1/3 sticky top-32">
            <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100">
              ...
              {/* Checkout Button */}
              <button className="w-full bg-[#FF2865] text-white py-5 rounded-xl font-bold uppercase tracking-[0.2em] hover:bg-[#1C1917] transition-all duration-300 flex items-center justify-center gap-3 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                Proceed to Checkout
