...
export default function Cart() {
  ...
  // --- MOCK DATA (In a real app, this comes from Context/Redux) ---
  const [cartItems, setCartItems] = useState([
    {
      id: 1,
      name: "The Royal Jutti",
      size: "38",
      price: 2499,
      quantity: 1,
      image:
        "https://images.unsplash.com/photo-1605218427368-35b866c24195?q=80&w=600",
    },
    {
      id: 2,
      name: "Velvet Mules",
  ...
  if (cartItems.length === 0) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4 pt-24">
        ...
        <h2 className="text-3xl font-serif text-[#1C1917] mb-2">
          Your Bag is Empty
        </h2>
  ...
  return (
    <div className="bg-[#F9F8F6] min-h-screen pt-24 pb-24">
      ...
      <div className="px-6 mb-12 text-center md:text-left md:px-12 max-w-[1440px] mx-auto">
        <h1 className="text-4xl font-serif text-[#1C1917] mb-2">
          Shopping Bag
        </h1>
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="w-full lg:w-2/3 space-y-6">
              ...
              >
                ...
                <div className="flex-grow">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="font-serif text-lg md:text-xl text-[#1C1917]">
                      {item.name}
                    </h3>
                    <button
                  ...
                  <div className="flex justify-between items-end">
                    ...
                    {/* Price */}
                    <p className="font-bold text-lg text-[#1C1917]">
            ...
            <Link
              to="/shop"
              className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-[#FF2865] mt-4 font-medium"
            >
