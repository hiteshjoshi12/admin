  ...
  return (
    <div className="max-w-5xl mx-auto py-10 px-6">
      ...
      <div className="flex items-center gap-4 mb-8">
        <Link to="/admin/orders" className="p-2 bg-white rounded-full border border-gray-200 hover:bg-gray-50 transition-colors">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
                <div>
                   <label className="text-xs text-gray-400 font-bold uppercase">Customer</label>
                   <p className="font-medium text-gray-900 mt-1 flex items-center gap-2">
                     <User className="w-3 h-3" /> {order.user?.name || 'Guest User'}
                   </p>
                   <p className="text-gray-500 ml-5">{order.user?.email}</p>
                </div>
                <div>
                   <label className="text-xs text-gray-400 font-bold uppercase">Phone</label>
                   <p className="font-medium text-gray-900 mt-1">{order.shippingAddress.phoneNumber}</p>
                </div>
           ...
           <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
              ...
              {order.awbCode && (
                 <div className="mb-6 p-3 bg-blue-50 border border-blue-100 rounded-lg">
                    ...
                    <p className="text-lg font-mono font-bold text-blue-800">{order.awbCode}</p>
                 </div>
              )}
